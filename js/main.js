...
async function getEmployersAsync() {
	let response = await fetch(
		// TODO: use const;
		`http://my-json-server.typicode.com/bisiakowsky/employer-list/employers`
	);
	let employers = await response.json(); // TODO: use const;
	return employers;
}

//generating table with employers
getEmployersAsync().then(employers =>
	employers.map(emp => {
		const panel = document.createElement("div"); // TODO: generating panel for users list could be a separate function
	...
	`;
		...
		getUserDetails = id => {
			// TODO: employers[id] won't work for last user since it search by index of element in array
			document.querySelector("section").innerHTML = "";
			const details = document.createElement("div");
			details.classList.add("employer-details");
			document.querySelector("section").appendChild(details);

			// TODO: details.innerHTML could be stored as separate HTML template and do not need to be duplicated
			// TODO: {
			// TODO:  if (id) {
			// TODO: 		 return createUserPanel(user);
			// TODO:    }
			// TODO:    return createUserPanel();
			// TODO: }
			// TODO:
			if (id === undefined) {
				details.innerHTML = `
...
const showEmptyPanel = () => {
	document.querySelector("section").innerHTML = ""; // TODO: do not select elements by html tags // this could be used to clear multiple elements
};

//remove user
const dismissalUser = id => {
	fetch(
		`http://my-json-server.typicode.com/bisiakowsky/employer-list/employers/${id}`,
		{
			method: "DELETE"
		}
	).then(swal("successful", "user dismissaled", "success"));
};
...
const editUserDetails = id => {
	...
	let obj = {}; // TODO: use meaningful variable names

	for (let i = 0; i < clicked.length; i++) {
		// TODO: use clicked.forEach(elem => ...)
	...
	if (id === undefined) {
		...
		fetch(
			"http://my-json-server.typicode.com/bisiakowsky/employer-list/employers", // TODO: adding/editing user could be extracted to separate function (example below)
			{
				method: "POST",
			...
			(document.querySelector(".employer-details").innerHTML = ""), // TODO: clearing html could be extracted to separate function
		...
		fetch(
			...
			.then(swal("successful", "user updated", "success"));
	}
};

// TODO: function sendUserData(user) {
// TODO:   fetch(
// TODO: 	 `http://my-json-server.typicode.com/bisiakowsky/employer-list/employers/${user.id}`,
// TODO: 	 {
// TODO: 		 method: `${user.id ? `PUT` : `POST`}`,
// TODO: 		 body: JSON.stringify(user.data),
// TODO: 		 headers: {
// TODO: 			 "Content-type": "application/json; charset=UTF-8"
// TODO: 		 }
// TODO: 	 }
// TODO:   ).then(swal("successful", `${user.id ? "user updated" : "user added"}`, "success"));
// TODO: }
